...
public class StreamPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("mapToDouble : " + Arrays.stream(nums2)
                .distinct()
                .mapToDouble(i -> i / 2D)
                .sum());
        ...
        List<Integer> evens = list5.stream()
                .filter(p -> p % 2 == 0)
                .collect(Collectors.toList());
        ...
        boolean r1 = list6.stream()
                .allMatch(p -> p % 2 == 0);
        System.out.println(r1);


        boolean r2 = list6.stream()
                .anyMatch(p -> p > 20);
        System.out.println(r2);

        boolean r3 = list6.stream()
                .noneMatch(p -> p % 3 == 0);
