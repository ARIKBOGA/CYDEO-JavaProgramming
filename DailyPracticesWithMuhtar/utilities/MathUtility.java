...
public class MathUtility {
    ...
    public static double getMax(double a,double b){return Math.max(a, b);}
    public static int getMin(int a,int b){return Math.min(a, b);}
    public static double getMin(double a,double b){return Math.min(a, b);}
    ...
    public static int absolute(int a){return a > 0 ? a : -a;}
    public static double absolute(double a){return a > 0 ? a : -a;}
}