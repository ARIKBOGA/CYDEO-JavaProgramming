...
public class LaptopConfiguration {
    public static void main(String[] args) {
        ...
        switch (cpuType){
            case "i3": totalPrice+=150; break;
            case "i5": totalPrice+=250; break;
            case "i7": totalPrice+=350;
        }
        ...
        switch (strogeType){
            case "SSD": totalPrice+= 100*(memorySize / 500); break;
            case "HDD": totalPrice+= 50*(memorySize / 500);
        }
